	...
	<body class="no-skin">
					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<span class="user-info"><small>欢迎,</small>${userinfo.uName }</span>
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				<ul class="nav nav-list">
					...
					<li class="nav-top-li" id="side3">
						<a href="#" class="dropdown-toggle" target="right" onclick="material_donation()">
							<i class="menu-icon fa fa-material"></i>
							<span class="menu-text">物资捐赠</span>
						</a>
						<b class="arrow"></b>
					</li>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">毕业设计</span>
							物资捐赠管理系统 &copy; 2019
						</span>
						&nbsp; &nbsp;
					</div>
		...
		<script type="text/javascript">
			...
			function material_donation() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/materials_donation");
			}
			...
			function check_0() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toMaterialsCheck_0");
			}
			...
			function check_1() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toMaterialsCheck_1");
			}
			...
			function check_2() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toMaterialsCheck_2");
			}
