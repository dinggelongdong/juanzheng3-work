	...
	<body class="no-skin">
				...
				<ul class="nav nav-list">
					<li class="nav-top-li active" id="side1">
						<a href="${pageContext.request.contextPath}/admin/main" target="right" onclick="profile()">
							...
							<span class="menu-text"> 管理员：${userinfo.uName } </span>
						</a>
						<b class="arrow"></b>
					</li>
		...
		<script type="text/javascript">
			...
			function check_0() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/admin/toMaterialCheck_0");
			}
			...
			function check_1() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/admin/toMaterialCheck_1");
			}
			...
			function check_2() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/admin/toMaterialCheck_2");
			}
