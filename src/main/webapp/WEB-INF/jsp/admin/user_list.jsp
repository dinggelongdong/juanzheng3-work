	...
	<body class="no-skin">
															...
															<tr>
																...
																<td>
																	<div class="hidden-sm hidden-xs btn-group">
																		...
																		<button class="btn btn-xs btn-info" title="编辑" onclick="toAdminEditUser('${user.uId}')">
																			<i class="ace-icon fa fa-pencil bigger-120"></i>
																		</button>
																		<button class="btn btn-xs btn-danger" title="删除" onclick="adminDelUserByUserId('${user.uId}')" >
		...
		<script type="text/javascript">
			...
			function toAdminEditUser(u_id) {
				window.location.href="toAdminEditUser?uId=" + u_id;
			}
