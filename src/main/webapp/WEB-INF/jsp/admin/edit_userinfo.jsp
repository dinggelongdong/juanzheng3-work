								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="text" id="u_role" name="u_role" value="${user.uRole == 1 ? '普通用户' : '管理员' }" readonly="readonly" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > 用户名 </label>
										<div class="col-sm-9">
											<input type="text" id="u_name" name="u_name" readonly="readonly" value="${user.uName }" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="radio" name="u_sex" readonly="readonly" value="女" ${user.uSex eq "女" ? "checked" : "" } />女
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > 手机号 </label>
										<div class="col-sm-9">
											<input type="text" id="u_phone" name="u_phone" readonly="readonly" value="${user.uPhone }" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > 邮箱 </label>
										<div class="col-sm-9">
											<input type="text" id="u_email" name="u_email" readonly="readonly" value="${user.uEmail }" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
