										...
										<div class="col-xs-12 col-sm-3 center">
											...
											<div class="profile-contact-info">
												<div class="profile-contact-links align-left">
													每成功捐赠一份物资，您的积分将 +1，积分达到一定数值后，可在物资中心领取更多奖励
												</div>
												<div class="space-6"></div>
											</div>
													...
													<c:when test="${not empty materials }">
														<div class="profile-info-row">
															...
															<div class="profile-info-value">
																<span class="editable" id="m_name"> ${materials.mMaterialName } </span>
															</div>
														</div>
														<div class="profile-info-row">
															<div class="profile-info-name"> 捐赠人 </div>
															<div class="profile-info-value">
																<span class="editable" id="m_author"> ${materials.mDonator }</span>
															</div>
														</div>
														<div class="profile-info-row">
															<div class="profile-info-name"> 物资类型 </div>
															<div class="profile-info-value">
																<span class="editable" id="age">${materials.mMaterialType }</span>
															</div>
														</div>
														<div class="profile-info-row">
															<div class="profile-info-name"> 审核日期 </div>
															<div class="profile-info-value">
																<span class="editable" id="signup">${materials.mCheckdate }</span>
															</div>
														</div>
														<div class="profile-info-row">
															<div class="profile-info-name"> 捐赠日期 </div>
															<div class="profile-info-value">
																<span class="editable" id="login">${materials.mDate }</span>
															</div>
														</div>
													</c:when>
													<c:otherwise>
